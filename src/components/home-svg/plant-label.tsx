...
const CARD =
  ...
  "hover:w-[21.7188cqw] hover:rounded-[0.9375cqw] hover:gap-[0.625cqw]";
...
export function PlantLabel({ href, label, blurb, leftPct, topPct }: PlantLabelProps) {
  return (
    <Link
      ...
      className={`group pointer-events-auto absolute inline-flex flex-col items-start whitespace-nowrap shadow-card backdrop-blur-[0.6945cqw] transition-[background-color,width,border-radius] duration-200 ease-out no-underline hover:bg-surface hover:backdrop-blur-[0.9375cqw] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black ${CARD}`}
    >
